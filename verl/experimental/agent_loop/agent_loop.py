...
class AgentLoopBase(ABC):
    ...
    def __init__(
        self, trainer_config: _DummyConfig, server_manager: AsyncLLMServerManager, processing_class: Union[AutoTokenizer, AutoProcessor], **kwargs
    ):
        ...
        Args:
            ...
            processing_class (AutoTokenizer|AutoProcessor): Tokenizer for tokenize messages.
        """
    ...
    @classmethod
    def init_class(cls, config: DictConfig, processing_class: Union[AutoTokenizer, AutoProcessor], **kwargs):
